...
public static void addStudentToACourse() 
{
	...
	// start a transaction
				...
				// create a course
				Course javaCourse = new Course("Amex Java FullStack ");
				...
				Student javaPrachi2 = new Student("Prachi3", "Jesus3", "pjesus3@gmail.com");
				
							
				// add students to the course
				javaCourse.addStudent(javaPrachi2);
				
				
				// save the students
				System.out.println("\nSaving students ...");
				session.save(javaPrachi2);
     ...
     public static void AddCourse() {
			...
			// create a course
			Course javaCourse = new Course("Amex2 SQL Back-end");
